...
#define SpawnerMethod$queueCallback 6			// (str)callback - Sends a callback when the previous queue finishes
...
#define Spawner$queueCallback(targ, callback) runMethod((string)targ, "got Spawner", SpawnerMethod$queueCallback, [callback], TNN)
