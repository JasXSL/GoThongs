...
#define NPCIntMethod$addTextureDesc 9	// PC uses EvtMethod$addTextureDesc | pid, texture, desc, added, duration, stacks - Adds a spell icon
...
#define NPCInt$addTextureDesc(pid, texture, desc, added, duration, stacks) runMethod((string)LINK_ROOT, "got NPCInt", NPCIntMethod$addTextureDesc, [pid, texture, desc, added, duration, stacks], TNN)
