...
#define NPCIntMethod$addTextureDesc 9	// PC uses EvtMethod$addTextureDesc | pid, texture, desc, added, duration, stacks, casterSubstr(8), (bool)detrimental - Adds a spell icon
...
#define NPCInt$addTextureDesc(pid, texture, desc, added, duration, stacks, casterKey, flags) runMethod((string)LINK_ROOT, "got NPCInt", NPCIntMethod$addTextureDesc, [pid, texture, desc, added, duration, stacks, llGetSubString(casterKey,0,7), flags&PF_DETRIMENTAL], TNN)
