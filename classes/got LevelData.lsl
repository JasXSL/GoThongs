...
#define gotLevelData$cellData(targ, data) runMethod(targ, "got LevelData", gotLevelDataMethod$cellData, [data], TNN)
#define gotLevelData$cellDesc(targ, desc) runMethod(targ, "got LevelData", gotLevelDataMethod$cellDesc, [desc], TNN)
...
#define gotLevelData$difficulty(targ, difficulty, challenge) runMethod(targ, "got LevelData", gotLevelDataMethod$difficulty, [difficulty, challenge], TNN)
